		...
		<>
			...
			<main className=" flex flex-col justify-center items-center gap-5 min-h-screen pt-16 px-3 lg:px-5">
				<div className="flex gap-5 justify-center items-center">
					...
					<LearnMore>
						<h4 className="font-bold text-xl text-green-300">
							How to Guess Hex Color Numbers?
						</h4>
						<p>
							Hexadecimal color codes are a way of representing colors in a
							digital format. Here are some tips to guess them correctly if you
							know what RGB is:
						</p>
						<ul className="space-y-2">
							<li>
								...
								Hex codes are 6-digit combinations of numbers and letters from 0
							...
							<li>
								...
								Red, green, and blue are the primary RGB colors. &apos;FF&apos;
								represents the highest intensity of a color (255).
							</li>
							<li>
								<strong className="text-green-500">
									Detailed RGB to Hex Conversion:
								</strong>{" "}
								To convert an RGB value to Hex, divide each RGB component (R, G,
								B) by 16. The quotient gives the first character (0-9 or A-F),
